...
datas = []
for arrs in uproot.iterate(args.input_file+":Events",input_features+['SDVTrack_LLPIdx'], library='np'):
...
torch.save(datas,args.output_dir+'/{}.pt'.format(os.path.splitext(os.path.basename(args.input_file))[0]))
